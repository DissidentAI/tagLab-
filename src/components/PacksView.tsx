        ...
        {MASTER_PACKS.map((pack) => {
          ...
          return (
            <div
              ...
              className="bg-white border border-slate-200 hover:border-slate-300 rounded-xl p-5 shadow-sm flex flex-col justify-between transition-all group"
            >
              <div>
                {/* Pack Header */}
                <div className="flex items-start justify-between gap-3 mb-2.5">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 text-[11px] font-mono font-semibold px-2.5 py-1 rounded-lg bg-slate-50 border border-slate-200 text-slate-600">
                    <span>{charCount}/500 car.</span>
                  </div>
                </div>

                {/* Tags Preview Box */}
                <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-200 my-3.5 font-mono text-xs text-slate-700 leading-relaxed max-h-36 overflow-y-auto">
              ...
              <div className="pt-3 border-t border-slate-100 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 py-1.5 px-2.5 rounded-lg bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-[11px] font-semibold flex items-center justify-center gap-1.5 transition-colors shadow-2xs"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-1.5 px-2.5 rounded-lg bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 text-indigo-700 text-[11px] font-semibold flex items-center justify-center gap-1.5 transition-colors shadow-2xs"
                  >
